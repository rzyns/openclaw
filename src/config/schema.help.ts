...
export const FIELD_HELP: Record<string, string> = {
  ...
  "talk.sttProvider": 'Active Talk STT provider id (for example "openai").',
  "talk.sttProviders": "Provider-specific Talk STT settings keyed by provider id.",
  "talk.sttProviders.*": "Provider-owned Talk STT config fields for the matching provider id.",
  "talk.sttProviders.*.apiKey": "Provider API key for Talk STT mode.", // pragma: allowlist secret
